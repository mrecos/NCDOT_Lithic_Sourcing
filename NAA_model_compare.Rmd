...
##################################!!!!!!!!!!!!!!!!!!!#####################
## 2021/07/14 HBD! - think I solved this. We needed a wide form.
## That needed an extra as.data.frame to take a named vector into df
## Not sure what in `map2()` changed, but troublesome error to fix
...
## here is wide form (USE THIS! was able to replicate original results)
loo_mah_distance <- map2(y_train, names(y_train),
                     function(.y,.name) loo_mah_func(.y, .name, NAA_train_data_pca)) %>%
